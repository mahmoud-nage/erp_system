        ...
        <div class="card-content">
          <div class="card-body">
            ...
            @if(!empty($record) && $record->name_ar == null)
                   {{-- @dd('create') --}}
                   <div class=" content-header col-lg-12 @if(app()->getLocale() == 'ar') text-right @endif">{{__('lang.new_stage')}}</div><br>
                    <form class="form-horizontal" method="POST" action="{{route('stage.store')}}">

                @else
                   {{-- @dd('update') --}}
                   <div class=" content-header col-lg-12 @if(app()->getLocale() == 'ar') text-right @endif">{{__('lang.edit_stage')}}</div><br>
                    <form class="form-horizontal" method="POST" action="{{route('stage.update', $record->id)}}">
