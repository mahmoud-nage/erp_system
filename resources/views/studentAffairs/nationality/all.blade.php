...
<div class="card">
    <div class="card-header">
        <h1 >{{__('lang.nationalities')}}</h1><br>
    </div><!-- /.card-header -->
    <div class="card-body">
        <div>
            <div class="row">
...
{{-- @section('content')
    ...
    <div class="card">
        <div class="card-header @if(app()->getLocale() == 'ar') text-right @endif">
            <h1>{{__('lang.nationalities')}}</h1>

            <a class="btn btn-outline-primary" style="width: 100px;" href="{{route('nationality.create')}}">
                                ...
                                @foreach($records as $record)
                                        <tr>
                                            ...
                                            <td class="text-center" >
                                                <a class="btn btn-info btn-group-vertical" href="{{route('nationality.edit', $record->id)}}">
                                                    <i class="fas fa-user-edit"></i>
                                                </a>
                                
                                                <form action="{{route('nationality.destroy', $record->id)}}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
